...
male_rb = ttk.Radiobutton(gender_frame, text="Male", variable=gender_var, value=1)
male_rb.pack(side='left')
female_rb = ttk.Radiobutton(gender_frame, text="Female", variable=gender_var, value=2)
...
cancel_button = tb.Button(frame3, text="Cancel", command=cancel, bootstyle="danger-outline", width=10)
cancel_button.pack(side='right', padx=10, pady=10)
submit_button = tb.Button(frame3, text="Submit", command=submit, bootstyle="success-outline", width=10)
